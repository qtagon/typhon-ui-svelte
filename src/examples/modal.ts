...
const modal = dynamic
  .setModal('Modal Title', 'Lorem ipsum , this is a modal example')
  .setVisible(true);
modal
  .setButton('Default')
  .setClassified('transparent bordered')
  .setIcon('close');
modal.setButton('Home').setIcon('home');
 ...
 */
menu.setOption('Modal').setClassified('active');
...
content_container.setSubject('Modal').setClassified('h1');
