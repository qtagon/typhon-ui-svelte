 ...
 */
menu.setOption('Message').setClassified('active');
...
content_container.setSubject('Message').setClassified('h1');
...
const message_e1 = content_container.setMessage('John', 'Doe');
